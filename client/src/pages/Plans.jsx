...
export default function Plans() {
  ...
  return (
    <div className="container">
      ...
      <p className="subtle">
        Upgrade for unlimited views, interests, and premium placement.
      </p>
      ...
      <div className="grid grid-3" style={{ gap: '1rem' }}>
        {plans.map((plan) => (
          <div
            key={plan.id}
            className="card"
            style={plan.popular ? { border: '2px solid #c44569' } : {}}
          >
